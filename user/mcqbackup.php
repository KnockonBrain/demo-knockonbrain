   ...
   session_start();
    ...
    $user_type=$user_date['type'];
        ...
        if(isset($_POST['submit'])&& !empty($_POST['testtype'])&& !empty($_POST['address']))
        {
            ...
            foreach($email as $d)
            {
              $sql="INSERT INTO details(cid,quiz_id,date,email,exp_date) VALUES(:cid,:tid,:timestamp,:d,:exp)";
              $stmt=$pdo->prepare($sql);
              $stmt->execute(['cid'=>$cid,'tid'=>$tid,'timestamp'=>$timestamp,'d'=>$d,'exp'=>$exp]);
            }
        
           header("Location:minvitationbackup.php?tid=$tid&date=$timestamp");
             }
        else
        { 
			...
			$("#authors").change(function(){
				...
				$.ajax({
					...
					books.forEach(function(book){
					   ...
					   {
					   $('#books').append( '<option value="' + book.id + '">' + book.category + " - " +book.company + '</option>')
					   }
					})
				})
			})
                ...
                <div class="pcoded-inner-content">
                    ...
                    <div class="main-body">
                        <div class="page-wrapper">
		                    ...
		                    <br>
		                    <div class="grid-item">
		                    <label id="dropdown_lab" for="authors"><i class="fa fa-calendar-plus-o" ></i>&nbsp;&nbsp;&nbsp;Select Test</label>
		                    </div>
		                    ...
		                    <select id="books" name="testtype" class="text">
                                                    ...
                                                    <center>
                                                    <div class="grid-item">
                                                        <p>If don't have mails? <a href="mcqcustom.php">Click Here!</a></p>
                                                    </div>
                                                    </center>
                                                    <br>
                                                    <center>
    ...
    <div id="myModal" class="modal">
        ...
        <div class="modal-content">
            ...
            <ol class="list">
                ...
                <li class="licl">The link will be valid for 48 hours, candidate can attempt the test anytime within time limit.</li>
