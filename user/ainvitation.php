...
// 			$mail->Subject = 'Test Invitation-KnockOnBrain';
    ...
    echo "<div class='container text-center'><a href='https://phptest.avianglobes.com/user/assessment.php'".$cname."/'><button class='feedback2' style='margin-top:0.6rem'>Schedule More Test</button></a></div>";	
