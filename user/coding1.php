                                            ...
                                            <span style="float: right; color: #2B3856; cursor: pointer; margin-top:10px;" id="myBtn" class="mybtn"><i style="font-size:21px;" class="fa fa-info-circle"></i></span>
                                                ...
                                                <form name="f1" id="f1" method="POST" action="">
                                                    ...
                                                    <div class="flex-container">
                                                        ...
                                                        <div class="grid-item">
                                                        <label class="col-md-4" style="max-width: 100%; padding: 2px;">
                                                            <input type="radio" value="C"> C
                                                            <input type="radio" value="Cpp" style="margin-left: 5px;"> C++
                                                            <input type="radio" value="Java" style="margin-left: 5px;"> Java
                                                            <input type="radio" value="Python" style="margin-left: 5px;"> Python
                                                            <input type="radio" value="PHP" style="margin-left: 5px;"> PHP
                                                            <input type="radio" value="Csharp" style="margin-left: 5px;"> C#
                                                            <input type="radio" value="JavaScript" style="margin-left: 5px;"> JavaScript
                                                            <input type="radio" value="Ruby" style="margin-left: 5px;"> Ruby
