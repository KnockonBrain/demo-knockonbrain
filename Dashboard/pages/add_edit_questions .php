...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <main class="main-content position-relative border-radius-lg" style="margin-left: 21%; width: 80%;">
    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-12">
          <div class="card mb-4" style="margin-left:1%">
            <div class="card-header pb-0">
              <h6>Add Questions Inside <?php echo $exam_category ?> Test</h6>
            </div>
            <form action=""name="form1" method="post">
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0" style="margin-left:1%">
                  <div class="form-group">
                      <label for="company" class=" form-control-label" >Question</label><textarea  name="question" placeholder="Add Question" class="form-control" required></textarea></div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-left text-uppercase text-xs font-weight-bolder">Questions</th>
                      <th class="text-left text-uppercase text-xs font-weight-bolder">Option 1</th>
                      <th class="text-left text-uppercase text-xs font-weight-bolder">Option 2</th>
                      <th class="text-left text-uppercase text-xs font-weight-bolder">Option 3</th>
                      <th class="text-left text-uppercase text-xs font-weight-bolder">Option 4</th>
                      <th class="text-left text-uppercase text-xs font-weight-bolder">Answer</th>
                      <th class="text-left text-uppercase text-xs font-weight-bolder">Level</th>
                      <th>Edit</th>
                      <th>Delete</th>
                                ...
                                while($row=mysqli_fetch_array($res))
                                        {
                                            ...
                                            <td style="white-space: normal;"><span class="text-secondary text-xs font-weight-bold"><?php echo $row['question']; ?></td>
                                            <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?php echo $row['opt1']; ?></td>
                                            <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?php echo $row['opt2']; ?></td>
                                            <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?php echo $row['opt3']; ?></td>
                                            <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?php echo $row['opt4']; ?></td>
                                            <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?php echo $row['answer']; ?></td>
                                            <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?php echo $row['level']; ?></td>
                                            <td class="align-middle text-center"><span class="text-secondary text-s font-weight-bold"><a href="./edit_options.php?userid=<?php echo $row["id"]; ?>&id=<?php echo $row["id"]; ?>">Edit</a></td>
                                            <td class="align-middle text-center"><span class="text-secondary text-s font-weight-bold"><a href="./delete_options.php?userid=<?php echo $row['id']; ?>&id=<?php echo $row["id"]; ?>"  onclick="return confirm('Are you sure?');">Delete</a></td>
