      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-body px-0 pt-0 pb-2" style="margin-left:1%">
        ...
        <?php
         if(isset($_POST["submit1"]))
            ...
            $out3=mysqli_real_escape_string($link,$_POST['out3']);
                ...
                $sql="update code_question set qdesc='".$qdesc."',inp1='".$inp1."',inp2='".$inp2."',inp3='".$inp3."',out1='".$out1."',out2='".$out2."',out3='".$out3."' WHERE qid='" . $_GET["userid"] . "'";
