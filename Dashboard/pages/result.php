                    ...
                    <table class="table align-items-center mb-0" id="table">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Quiz Name</th>
                             ...
                             <?php
                                ...
                                if(mysqli_num_rows($query_run)>0){
                                    foreach($query_run as $row){
                                    	...
                                    	<td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?php echo $row['result_id'];?></td>
                                    	<td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?php echo $row['Email'];?></td>
                                    	<td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?php echo $row['quiz_name'];?></td>
                                    	<td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?php echo $row['scoreper']?></td>
                                    	<td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?php echo $row['video_link'];?></td>
                                    	<td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?php echo $row['AI_accuracy'];?></td>
                                    	</tr>
                                    	<?php
                                    }
                                    echo "Count: $counter";
                                    ...
                                    $res=mysqli_query($link,"Select * from results order by End_time DESC");
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?php echo $row['Email']; ?></td>
                                                     ...
                                                     ?>
                                                    <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?php echo $scor; ?></td>
                                                    <?php
                                                   $vid=$row['video_link'];
                                                    ?>
                                                    <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><a href="check.php?vid=<?php echo $vid?>">Video Link</a></td>
                                                    <td class="align-middle text-center" id="<?php echo $row['result_id']; ?>" contenteditable="true"><?php echo $row['AI_accuracy']; ?></td>
                                                </tr> 
                                                <?php
                                                }
                    	                       }
                                                ...
                                                <tr>
                                                   ...
                                                   $vid=$row['video_link'];
                                                    ...
                                                    <td  class ="align-middle text-center" id="<?php echo $row['result_id']; ?>" contenteditable="true"><span class="text-secondary text-xs font-weight-bold"><?php echo $row['AI_accuracy']; ?></span></td>
