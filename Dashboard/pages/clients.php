      ...
      <div class="row" style="margin-left:4px">
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-body px-0 pt-0 pb-2" style="margin-left:4px">
                  ...
                  <tbody>
                      ...
                      <?php
                                    	    ...
                                    	    if(mysqli_num_rows($query_run)>0){
                                    	          ...
                                    	          ?>
                                    	            <tr>
                                    	                <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold">
                                    	                    <?php echo ++$counter;?></span></td>
                                    				    <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold">
                                    				        <?php echo $row['user_email'];?></span></td>
                                    				    <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold">
                                    				        <?php echo $row['Phone'];?></span></td>
                                    				    <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold">
                                    				        <?php echo $row['company'];?></span></td>
                                    				    <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold">
                                                            <a href="./viewClients.php?userid=<?php echo $row["ID"]; ?>">View</a></span></td>
                                    				    <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold">
                                                            <a href="./edit_clients.php?userid=<?php echo $row["ID"]; ?>">Edit</a></span></td>
                                                    <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold">
                                                        <a href="delete_clients.php?userid=<?php echo $row["ID"]; ?>"onclick="return confirm('Are you sure?');" >Delete</a></span></td>
                                    	      ...
                                    	      echo "Count: $counter";
                                                ...
                                                while($row=mysqli_fetch_array($res))
                                                {
                                                    ...
                                                    ?>
                                                    <tr>
                                                    <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?php echo $count ?></span></td>
                                                    <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?php echo $row['user_email']; ?></span></td>
                                                    <?php 
                                                    $phn=$row['Phone'];
                                                    if($phn==NULL)
                                                    {
                                                    ?>
                                                    <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?php echo "NULL"; ?></span></td>
                                                    <?php
                                                    }
                                                    else
                                                    {
                                                    ?>
                                                    <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?php echo $phn; ?></span></td>
                                                    <?php
                                                    }
                                                    ?>
                                                    <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?php $pass= $row['user_password'];  $pass1=md5($pass);
                                                    echo $pass; ?></span></td>
                                                     <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold">
                                                        <a href="./viewClients.php?userid=<?php echo $row["ID"]; ?>">View</a></span></td>
                                                    <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold">
                                                        <a href="./edit_clients.php?userid=<?php echo $row["ID"]; ?>">Edit</a></span></td>
                                                    <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold">
                                                        <a href="delete_clients.php?userid=<?php echo $row["ID"]; ?>"onclick="return confirm('Are you sure?');" >Delete</a></span>
                                                    </td>
                                                    </tr>
                                                    <?php
                                                    }
                                        ...
                                        while($row=mysqli_fetch_array($res))
                                        {
                                            ...
                                            ?>
                                            <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold"><?php $pass= $row['company'];  //$pass1=md5($pass);
                                                            echo $pass; ?></span></td>
                                            <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold">
                                                <a href="./viewClients.php?userid=<?php echo $row["ID"]; ?>">View</a></span></td>
                                            <td class="align-middle text-center"><span class="text-secondary text-xs font-weight-bold">
