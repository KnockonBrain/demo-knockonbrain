...
@media (max-width: 580px){
    ...
    .signin-signup .ribbon{
        margin-bottom: 0;
    }
    
    .signin-signup #countdown li{
        margin-bottom: 20px;
    }
}
...
.strike{
    ...
    margin-bottom: 2%;
    font-weight: bold;
    text-shadow: -3px 2px 6px rgba(0,0,0,0);
...
<!--End of Tawk.to Script-->
  ...
  <header id="header" class="header fixed-top">
      <a href="index.php" class="logo d-flex align-items-center" style="text-decoration: none;">
        ...
        <img style="width:220px; color: white; max-height: revert; margin-top: 10px; " src="logo1.png" alt="">
        <!--<img src="assets/img/logo.png" alt="">-->
    ...
    <div class="container">
      <div class="forms-container">
        ...
        <form action="Signin.php" method="post" class="sign-in-form" id="hero" autocomplete="off" required="">
        ...
        <!--</div>-->
            ...
            <h2 class="title" style="padding-top: 36px;">Create Account</h2>
            ...
            <input onclick="sweetAlert('Successfully Registered!', 'You are now logged in on knockonbrain', 'success');" type="submit" value="Register" name="register" class="btn solid"/> 
            
            <h1 class="title" style="font-weight:100;font-size: 0.9em;"> Already have an account?</h1>
           <a href ="Signin.php" class="btn transparent" id="sign-up-btn" style="color:#67B2E0;">
             <u>Sign In</u> 
            </a>
    ...
    <div class="img1">
        ...
        <div class="col-lg-6 pt-4 pt-lg-0 content" style="margin-left: -23%;">
            ...
            <div class="skills-content">
              ...
              <div class="progress">
                <span class="skill">Time and Effort Saving <i class="val">90%</i></span>
              ...
              <div class="progress">
                <span class="skill">Cost Saving on Mis Hiring <i class="val">75%</i></span>
                <div class="progress-bar-wrap">
   ...
   <!--- About Us Section --->
    ...
    <section id="about" class="about">
      ...
      <div class="section-title">
        ...
        <div class="row gx-0" style="max-width: 960px; margin-left: 50px;">
            
            <div class="content" style="background-color: #f6f9ff; padding: 40px; margin-top: 20px; text-align: left; width: 120%;">
              <h3 style="font-size: 14px; font-weight: 700; color: #4154f1; text-transform: uppercase;">Knock On Brain</h3>
              <h3 style="font-size: 22px; font-weight: 700; color: #012970;">Portal designed to Help Corporates to Hire the Talents!</h3>
                 <p style="margin-bottom: 35px; width: 100%;"> Knock On Brain is smart online assessment tool to evaluate the job applicants and only tool in the market that provides recorded test video of candidate with AI/ML-based auto proctoring. <br>Portal is quite quick with intuitive flow, which can be used easily without any hassle.
...
We Make Recruitment Easy!</p>
          ...
          <div class="col-lg-6 d-flex align-items-center" >
            <img src="https://i.pinimg.com/originals/50/78/a0/5078a05eb1b6847d93383eaa4c0ed500.gif" class="img-fluid"  style="width: 120%;
    height: 90%; margin-bottom: -15px">
          </div>
  ...
  <!-- ======= Features Section ======= -->
  <section id="features" class="services section-bg" style="background-color: #f3f5fa;">
       <div class="section-title">
          <h2>Features</h2>
        ...
        <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0">
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="icon-box" style=" margin-left: 70px;">
              ...
              <h4><a>Schedule Unlimited Assessments</a></h4>
...
Knock on Brain.</p>
   ...
   <!-- ======= Gallery Section ======= -->
    <section id="gallery" class="section-bg" style="margin-bottom: 20px; background-color: #f3f5fa;">
        ...
        <div class="vid">
           ...
           src="https://www.youtube.com/embed/qZLlmxCNKg0?rel=0" title="YouTube video player" frameborder="0" 
    ...
    <div class="footer-top" style="display:flex;">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <div class="social-links mt-3" style="margin-left: 10px;">
              ...
              <a href="https://instagram.com/knockonbrain" class="instagram"><i class="bx bxl-instagram"></i></a>
