...
<?php
 ...
 $user= mysqli_query($con1, "Select * from users where ID=$cid");
    ...
    $user_type=$user_date['type'];
        ...
        if(isset($_POST['submit'])&&  !empty($_POST['address']))
        {
        ...
        $exp=Date('Y-m-d H:i:s', strtotime('+2 days'));
           ...
           header("Location:mail2mail_psycho.php?type=$type&date=$timestamp");
          }
        else
        { 
                                ...
                                <div class="col-md-10 col-xl-8 ">
                                    <div class="card daily-sales">
                                        ...
                                        <span class="contact100-form-symbol">
                                            <img src="human-brain-icon.png" alt="SYMBOL-MAIL">
                                        </span>
                                            ...
                                            <span style="float: right; color: #2B3856; cursor: pointer; margin-top:10px;" id="myBtn" class="mybtn"><i style="font-size:21px;" class="fa fa-info-circle"></i></span>
                                                ...
                                                <form name="f1" id="f1" method="POST" action="">
                                                    ...
                                                    <div class="flex-container">
                                                        <div class="grid-item">
                                                            <label id="dropdown_lab"><i class="fa fa-calendar-plus-o" ></i>&nbsp;&nbsp;&nbsp;Select Category</label>
                                                        </div>
                                                    ...
                                                    <center>
                                                    <div class="grid-item">
                                                        <p>If don't have mails? <a href="newpsychotest.php">Click Here!</a></p>
                                                    </div>
                                                    </center>
                                                    <br>
                                                    <center>
    ...
    <div id="myModal" class="modal">
        ...
        <div class="modal-content">
            ...
            <ol class="list">
                ...
                <li class="licl">The link will be valid for 48 hours, candidate can attempt the test within the time limit.</li>
