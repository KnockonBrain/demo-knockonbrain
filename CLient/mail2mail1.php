...
<body>
     <button class="feedback" onclick="location.href = '../CLient/new_file_code.php';" style="font-size:20px; float: right; margin-top: -100px;">View Results</button>
</body>
...
$result="https://35.154.101.124/code/start.php";
...
foreach($res as $m)
    ...
    echo "<div class='container text-center'><a href='https://35.154.101.124/CLient/codingtest.php'".$cname."/'><button class='feedback2' style='margin-top:0.6rem'>Schedule More Test</button></a></div>";		
