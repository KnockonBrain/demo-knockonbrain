...
<script>
        $(document).ready(function(){
            function create_list(data){
                if(document.getElementById("filter").value==='ocean'){
                var table = $('#table');
                table.html('');
                var table_head = $('<tr>');
                table_head.append($('<th>').text('EMAIL'))
                table_head.append($('<th>').text('START TIME'))
                table_head.append($('<th>').text('END TIME'))
                table_head.append($('<th>').text('RESULT'))
                table.append(table_head);
                for(var x in data){
                    var tr = $('<tr>');
                    tr.append($('<td>').text(data[x].email));
                    tr.append($('<td>').text(data[x].stime));
                    tr.append($('<td>').text(data[x].etime));
                  //  tr.append($('<td>').text(data[x].lg1));
                  //  tr.append($('<td>').text(data[x].lg2));
                  //  tr.append($('<td>').text(data[x].name));
                    tr.append($("<td>"+"<a href=psych_result.php?id="+data[x].id+">"+"View Report"+"</a>"));
                    table.append(tr);
                };
                }
                else{
                ...
                for(var x in data){
                  ...
                  //  tr.append($('<td>').text(data[x].lg2));
                  //  tr.append($('<td>').text(data[x].name));
                    tr.append($("<td>"+"<a href=psych_result_mbti1.php?id="+data[x].id+">"+"View Report"+"</a>"));
                    table.append(tr);
                }; 
                }
                
        }
         function create_list1(data){
                var table = $('#table');
                table.html('');
                var table_head = $('<tr>');
                table_head.append($('<th>').text('EMAIL'))
        ...
        function create_list2(data){
               ...
               /* var table_head = $('<tr>');
                ...
                for(var x in data){
                    var tr = $('<tr>');
                    tr.append($('<td>').text(data[x].email));
                    tr.append($('<td>').text("Personality Assessment"));
                    tr.append($('<td>').text(data[x].stime));
                    tr.append($('<td>').text(data[x].etime));
                  //  tr.append($('<td>').text(data[x].lg1));
                  //  tr.append($('<td>').text(data[x].lg2));
        ...
        if(document.getElementById("filter").value==='ocean'){
         $.ajax({
                url:'final_ocean.php?filter=all',
                type:'GET',
                success:function(data){
                    console.log(document.getElementById("filter").value);
                    var d = JSON.parse(data);
                                ...
                                <div class="col-xl-8 col-md-6 col-sm-12" >
                                    <div class="card Recent-Users" >
                                        <div class="card-header">
                                           ...
                                           <center><h3>Psychometric Test Results</h3></center>
                                        </div>
