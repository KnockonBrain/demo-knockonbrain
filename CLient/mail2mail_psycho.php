...
foreach($res as $m)
    ...
    echo "<div class='container text-center'><a href='https://35.154.101.124/CLient/psychotest.php'".$cname."/'><button class='feedback2' style='margin-top:0.6rem'>Schedule More Test</button></a></div>";		
