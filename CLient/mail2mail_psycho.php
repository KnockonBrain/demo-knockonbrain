...
<body>
     <button class="feedback" onclick="location.href = '../CLient/psych_result_table.php';" style="font-size:20px; float: right; margin-top: -100px;">View Results</button>
</body>
...
foreach($res as $m)
     {
		...
		$mail->isHTML(true);  // Set email format to HTML
		    ...
		    $mail->Body='
		      <div class="main-div" style="padding: 1rem; background-color: #ececec;">
                ...
                <li>Click on submit button to submit the test otherwise test will not be submitted.</li>
                ...
                <img src="https://cdn-icons-png.flaticon.com/128/1581/1581942.png" style="width: 20px;
                            ...
                            text-decoration: none;
                            margin-bottom: -5px !important;"></img>
                <b style="vertical-align: super; text-transform: uppercase;">TEST NAME : PSYCHOMETRIC TEST</b>
                <br>
                
                <center>
                    <div>
                        <a href="'.$result."?cid=".$cid."&id=".$resultid."&m1=".$m['email'].'" style="cursor:pointer !important; background-color: #012970;
                                    border:none;
                                    text-align: center;
		...
		//	$mail->Body="Heelooo";
		    ...
		    $mail->AltBody = "Test Link: ".$result."?cid=".$cid."&id=".$resultid."&m1=".$m['email']."  Test email: ".$m['email']."  Company Name: ".$company;
    ...
    echo "<div class='container text-center'><a href='https://phptest.avianglobes.com/CLient/psychotest.php'".$cname."/'><button class='feedback2' style='margin-top:0.6rem'>Schedule More Test</button></a></div>";		
