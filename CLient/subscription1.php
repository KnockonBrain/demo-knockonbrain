...
<div class="wrapper">
  ...
  <div class="pricing_table">
    <div class="pt_item pt_1">
      ...
      <div class="price">
        <p>
          <span class="money" style="text-decoration: line-through solid #db323e 5px; ">&nbsp; ₹ 7,500 &nbsp;</span>
         </p>
         <p>
...
var rzp1 = new Razorpay(options);
 rzp1.open();
    ...
    <div class="pt_item pt_2 ">
      ...
      <div class="price">
          <p>
              <span class="money" style="text-decoration: line-through solid #db323e 5px;">&nbsp; ₹ 10,500 &nbsp;</span>
          </p>
        <p>
...
var rzp1 = new Razorpay(options);
 rzp1.open();
    ...
    <div class="pt_item pt_4">
      ...
      <div class="price">
          <p>
              <span class="money" style="text-decoration: line-through solid #db323e 5px;">&nbsp; ₹ 18,000 &nbsp;</span>
          </p>
        <p>
          <!--<span class="rupee">&#8377;</span>-->
...
var rzp1 = new Razorpay(options);
 rzp1.open();
    ...
    margin-left: 100px; margin-top: 40px;"> Add-Ons </h2>
    <p style="font-size: 22px; font-weight: 300; font-family:'Times New Roman', Times, serif; float:right;">Add-on validity will be as <br>per the validity of your <br>base plan.</p>
    </div>
</div>
