...
// API_KEY = "f44121d93dmshfc59844194f3c18p108c72jsnd3606fe98cf6";//sir old
...
<div class="code-editor">
    ...
    <div class="cstatus">
       ...
       <textarea readonly disabled="yes" class="btnp" name="cstatus" id="cstatus" type="text" style="background: white; width:97.7%; margin-left:25px; font-size:30px;height: 62px;text-align:center;
    padding: 10px;padding-bottom:0px;margin-bottom:0px;color:black">Click on run button to run your code against sample test case.</textarea><br>
        <textarea readonly disabled="yes" class="btnp" name="cstatus2" id="cstatus2" type="text" style="background:white; width:97.7%; margin-left:25px; font-size:20px;height: 40px;text-align:center;
